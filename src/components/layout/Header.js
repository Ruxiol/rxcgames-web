                  ...
                  <div className="header-nav-inner">
                    ...
                    {!hideSignin &&
                      ...
                      >
                        ...
                        <li>
                          <DomLink to={{ pathname: "./../../assets/RXCGWhitepaper.pdf")" }} target="_blank" className="button button-primary button-wide-mobile button-sm" onClick={this.closeMenu}>Whitepaper</DomLink>
                        </li>                        
                      </ul>}
                  </div>
                </nav>
